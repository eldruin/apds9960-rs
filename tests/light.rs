...
read_data_test!(cdata, read_light_clear, 0xABCD, STATUS, [BitFlags::AVALID], CDATAL, [0xCD, 0xAB]);
read_data_test!(rdata, read_light_red, 0xABCD, STATUS, [BitFlags::AVALID], RDATAL, [0xCD, 0xAB]);
read_data_test!(gdata, read_light_green, 0xABCD, STATUS, [BitFlags::AVALID], GDATAL, [0xCD, 0xAB]);
read_data_test!(bdata, read_light_blue, 0xABCD, STATUS, [BitFlags::AVALID], BDATAL, [0xCD, 0xAB]);
