...
mod blocking {
    ...
    use core::result::Result as AsyncResult;
    #[maybe_async_cfg::only_if(sync)]
    use nb::Result as AsyncResult;
        ...
        I2C: I2cWriteRead<E, Error = E>,
    {
        ...
        /// This clears the data ready flag.
        #[maybe_async_cfg::only_if(async)]
        pub async fn read_light(&mut self) -> AsyncResult<LightData, Error<E>> {
        ...
        /// This clears the data ready flag.
        pub async fn read_light_clear(&mut self) -> AsyncResult<u16, Error<E>> {
        ...
        /// Blocks while the data is not ready.
        /// This clears the data ready flag.
        pub async fn read_light_red(&mut self) -> AsyncResult<u16, Error<E>> {
        ...
        /// Blocks while the data is not ready.
        /// This clears the data ready flag.
        pub async fn read_light_green(&mut self) -> AsyncResult<u16, Error<E>> {
        ...
        /// Blocks while the data is not ready.
        /// This clears the data ready flag.
        pub async fn read_light_blue(&mut self) -> AsyncResult<u16, Error<E>> {
